...
from inda_desk import rest
from inda_desk.configuration import Configuration
from inda_desk.exceptions import ApiTypeError, ApiValueError, ApiException
from inda_desk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.log_in_post  # this is an instance of the class Endpoint
        api_instance.log_in_post()  # this invokes api_instance.log_in_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.log_in_post.callable or self.callable in this class
