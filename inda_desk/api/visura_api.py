...
class VISURAApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.bulk_visura_parser_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListPdfBase64VisuraOutput,),
                'auth': [
                    'APIKey'
                ],
        ...
        self.visura_parser_post_endpoint = _Endpoint(
            settings={
                'response_type': (OptionalVisuraDoc,),
                'auth': [
                    'APIKey'
                ],
    ...
    def visura_parser_post(
        ...
        **kwargs
        ...
        kwargs['pdfbase64'] = \
            pdfbase64
        return self.visura_parser_post_endpoint.call_with_http_info(**kwargs)
