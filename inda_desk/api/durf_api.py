...
class DURFApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.bulk_durf_parser_post_endpoint = _Endpoint(
            settings={
                'response_type': (ListPdfBase64DurfOutput,),
                'auth': [
                    'APIKey'
                ],
        ...
        self.durf_parser_post_endpoint = _Endpoint(
            settings={
                'response_type': (OptionalDurfDoc,),
                'auth': [
                    'APIKey'
                ],
    ...
    def durf_parser_post(
        ...
        **kwargs
        ...
        kwargs['pdfbase64'] = \
            pdfbase64
        return self.durf_parser_post_endpoint.call_with_http_info(**kwargs)
