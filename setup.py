...
setup(
    name=NAME,
    version=VERSION,
    description="INDA DESK - INtelligent Data Analysis for document parsing",
    author="Intervieweb",
    author_email="info@intervieweb.it",
    url="",
    keywords=["OpenAPI", "OpenAPI-Generator", "INDA DESK - INtelligent Data Analysis for document parsing"],
    python_requires=">=3.6",
